...
The code snippets shown in the following are taken from the above mentioned larger files and are individually avaiable at https://github.com/european-epc-competence-center/epcis-sanitisation/tree/master/paper/appendix .
...
[source,json]
----
include::shipping.sanitised.json[]
----
...
[source,json]
----
include::receiving.sanitised.json[]
----
